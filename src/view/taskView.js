...
import {ChatInputComponent,TagButton} from './commonComponent';
    ...
    render(){
        ...
        return(
            <div className={classes.root}>
                ...
                <Card className={classes.customScroll}>
                    <CardHeader
                        avatar={
                    ...
                    <CardContent style={{paddingTop:0}}>
                        <div className={classes.horizontalFlow}>
                            {/*<TagButton color={'primary'} text={"内容描述"} className={classes.horizontalTitle}/>*/}
                            {/*<TagButton color={'primary'} text={<Typography className={classes.horizontalTitle} type={'body2'}>内容描述</Typography>} />*/}
                        ...
                        <div className={classes.horizontalFlow}>
                            ...
                            {/*<Typography className={classes.horizontalTitle} type={'body2'}>承办人</Typography>*/}
                            <div component="p" style={{
                                flex:1,
                                borderRadius: 4,
                                border: '1px solid #ced4da',
                        ...
                        <div className={classes.horizontalFlow}>
                            ...
                            {/*<TagButton color={'primary'} text={<Typography className={classes.horizontalTitle} type={'body2'}>截至时间</Typography>} />*/}
                            <Typography component="p" style={{
                                flex:1,
                                borderRadius: 4,
                                border: '1px solid #ced4da',
